...
Frequently. I personally commit to git everytime I make siginificant changes to my code. I then like to push up my code to GitHub after a long day of programming.
